        ...
        with engine.connect() as connection:
            with connection.begin(): # Inicia uma transação
                ...
                FROM
                    ...
                    LEFT JOIN DevedorCliente cdev ON cdev.CodDevedor = pro.CodDevedor AND pro.CodCliente = cli.CodCliente
                    ...
                    INNER JOIN #TempDados tmp ON cdev.CodDevedorCliente = tmp.CNPJTemp AND tmp.TituloTemp = pt.CodTitulo AND tmp.ParcelaTemp = pt.CodParcela
                GROUP BY
                    pro.CodProcesso,
                    pt.CodTitulo,
                    pt.CodParcela,
