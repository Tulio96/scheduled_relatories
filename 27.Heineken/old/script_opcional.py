from querys_heineken_opcional import executar_querys
from ler_excel_opcional import importar_dados_excel

# --- Bloco principal (sem alterações) ---
if __name__ == "__main__":
    CAMINHO_ARQUIVO = r"/mnt/Rede/MIS/B2B - Global/27 - Heineken/Base.xlsx"
    NOME_PLANILHA = r"Inc"
    COLUNA = r"Codigo "
#    COLUNA = "CNPJ/CPF - Devedor"
    COLUNA_TITULO = r"OPCIONAL"
