...
def static_table_unidades(
    ...
    def estilo_delta(valor):
        if valor > 0:
            ...
            return "color: #ff6347; font-weight: bold;"
        else:
            return "color: white;"
    ...
    col_borders = [
        ...
        {
            "selector": f"td.col{df.columns.get_loc('Acion_C')}",
            "props": [("border-right", "3px solid black")]
        },
        {
            "selector": f"th.col{df.columns.get_loc('Acion_C')}",
            "props": [("border-right", "3px solid black")]
        },
        ...
        {
            "selector": "thead th",
            "props": [("border-top", "3px solid black"), ("border-bottom", "2px solid black")]
        }
    ]
    ...
    colunas_com_borda = ["Hora", "Valor_C", "TKM_C", "Acordos_C", "Acion_C", "Acordos_H", "Valor_H", "TKM_H", "Acion_H", "Δ_Acordos", "Δ_Valor","Δ_TKM"]
...
def static_table_previsao_unidades(
    df: pd.DataFrame,
    text_align: Literal["left", "center", "right"] = "center",
    line_color: str = "rgba(1, 1, 1, 1000)",
) -> None:
    ...
    col_borders = [
        {
            ...
            "props": [("border-right", "2px solid black"), ("border-left", "3px solid black"), 
                      ("border-top", "2px solid black"), ("border-bottom", "3px solid black")]
        },
                {
        ...
        {
            "selector": "thead th",
            "props": [("border-top", "2px solid black"), ("border-bottom", "3px solid black"),
                      ("border-left", "2px solid black"), ("border-right", "3px solid black")]
        }
    ]
